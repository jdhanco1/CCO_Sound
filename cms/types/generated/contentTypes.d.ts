...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog posts and devotionals';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['devotional', 'update', 'testimony', 'announcement']
    > &
      Schema.Attribute.DefaultTo<'devotional'>;
...
export interface ApiElderElder extends Struct.CollectionTypeSchema {
  collectionName: 'elders';
  info: {
    description: 'Church elders';
    displayName: 'Elder';
    pluralName: 'elders';
    singularName: 'elder';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::elder.elder'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    photo: Schema.Attribute.Media<'images'>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Elder'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiEventRegistrationEventRegistration
  ...
  info: {
    description: 'Registrations submitted for specific events';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Church events with optional registration';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Homepage content \u2014 hero, about section, quick actions';
  ...
  attributes: {
    aboutHeading: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Welcome to Community'>;
    ...
    heroSubtitle: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'A Christ-centered church in Oxford, Mississippi'>;
    heroTagline: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Seek \u00B7 Shape \u00B7 Send'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    serviceLocation: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }> &
      Schema.Attribute.DefaultTo<'Lafayette High School Gym \u00B7 Oxford, MS'>;
    serviceTime: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'9:45 AM'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMinistryMinistry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Church ministry areas (Connect page)';
...
export interface ApiMissionPageMissionPage extends Struct.SingleTypeSchema {
  collectionName: 'mission_page';
  info: {
    description: 'Seek, Shape, Send \u2014 mission statement and scripture sections';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    essentialsCta: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    essentialsFormUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://communityoxford.ccbchurch.com/form_response.php?id=23'>;
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'mission.mission-section', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSermonSermon extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sermon archive with video/audio';
    displayName: 'Sermon';
    pluralName: 'sermons';
    singularName: 'sermon';
  };
